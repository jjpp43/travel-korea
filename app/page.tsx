      ...
      <div className="flex flex-col justify-center items-center h-screen bg-black">
        ...
        <div className="relative w-[1280px] h-[720px]">
          ...
          <div className="absolute right-0 flex flex-col justify-between h-full w-fit">
            ...
            <div className="w-[630px] text-end">
              ...
              and mountains. Sokcho is one of the most nature friendly and
              environmentally clean cities in South Korea. With beautiful
              scenaries of the sea and mountains.{" "}
            </div>
            {/* Image - bottom right */}
            <div className="relative">
              <Image
